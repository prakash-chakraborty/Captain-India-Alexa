...
const speechConsCorrect = ["All righty", "Bingo", "Bravo", "Cheers", "Hurray", "Oh dear.  Just kidding.  Hurray", "Well done"];
...
//speechcons, go here: https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/speechcon-reference
const speechConsWrong = ["Bummer", "Le sigh", "Oh boy", "Oh dear", "Oof", "Ouch", "Uh oh", "Wah wah",  "Yikes"];

//This is the welcome message for when a user starts the skill without a specific intent.
const WELCOME_MESSAGE = "Welcome to the Captain India Quiz Game! Here you can test your knowledge about India. Ask me to start a quiz!";

//This is the message a user will hear when they start a quiz.
const START_QUIZ_MESSAGE = "OK.  I will ask you 10 questions about India";

//This is the message a user will hear when they try to cancel or stop the skill, or when they finish a quiz.
const EXIT_SKILL_MESSAGE = "Thank you for playing the Captain India Quiz Game!  Let's play again soon!";

//This is the message a user will hear after they ask (and hear) about a specific data element.
const REPROMPT_SPEECH = "Okay. Let's Continue.";
...
//=========================================================================================================================================
const data = [
                {StateName: "Andaman and Nicobar Islands",  Capital: "Port Blair",  FormationYear: 1956, OfficialLanguage: "Hindi" },
                {StateName: "Andhra Pradesh", Capital: "Amravati", FormationYear: 1953, OfficialLanguage: "Telugu" },
                {StateName: "Arunachal Pradesh", Capital: "Itanagar", FormationYear: 1987, OfficialLanguage: "English" },
                {StateName: "Assam", Capital: "Dispur", FormationYear: 1950, OfficialLanguage: "Assamese" },
                {StateName: "Bihar", Capital: "Patna", FormationYear: 1950, OfficialLanguage: "Hindi" },
                {StateName: "Chattisgarh", Capital: "Naya Raipur", FormationYear: 2000, OfficialLanguage: "Hindi" },
                {StateName: "Goa", Capital: "Panaji", FormationYear: 1987, OfficialLanguage: "Konkani" },
                {StateName: "Gujarat", Capital: "Gandhinagar", FormationYear: 1960, OfficialLanguage: "Gujarati" },
                {StateName: "Haryana", Capital: "Chandigarh", FormationYear: 1966, OfficialLanguage: "Hindi" },
                {StateName: "Himachal Pradesh", Capital: "Shimla", FormationYear: 1971, OfficialLanguage: "Hindi" },
                {StateName: "Jammu and Kashmir", Capital: "Srinagar", FormationYear: 1950, OfficialLanguage: "Urdu" },
                {StateName: "Jharkhand", Capital: "Ranchi", FormationYear: 2000, OfficialLanguage: "Hindi" },
                {StateName: "Karnataka", Capital: "Bangalore", FormationYear: 1956, OfficialLanguage: "Kannada" },
                {StateName: "Kerala", Capital: "Thiruvananthapuram", FormationYear: 1956, OfficialLanguage: "Malayalam" },
                {StateName: "Madhya Pradesh", Capital: "Bhopal", FormationYear: 1956, OfficialLanguage: "Hindi" },
                {StateName: "Maharashtra", Capital: "Mumbai", FormationYear: 1960, OfficialLanguage: "Marathi" },
                {StateName: "Manipur", Capital: "Imphal", FormationYear: 1972, OfficialLanguage: "Meitei" },
                {StateName: "Meghalaya", Capital: "Shilong", FormationYear: 1972, OfficialLanguage: "English" },
                {StateName: "Mizoram", Capital: "Aizawl", FormationYear: 1987, OfficialLanguage: "English" },
                {StateName: "Nagaland", Capital: "Kohima", FormationYear: 1963, OfficialLanguage: "English" },
                {StateName: "Odisha", Capital: "Bhubaneswar", FormationYear: 1950, OfficialLanguage: "Oriya" },
                {StateName: "Punjab", Capital: "Chandigarh", FormationYear: 1966, OfficialLanguage: "Punjabi" },
                {StateName: "Rajasthan", Capital: "Jaipur", FormationYear: 1956, OfficialLanguage: "Hindi" },
                {StateName: "Sikkim", Capital: "Gangtok", FormationYear: 1975, OfficialLanguage: "English" },
                {StateName: "Tamil Nadu", Capital: "Chennai", FormationYear: 1950, OfficialLanguage: "Tamil" },
                {StateName: "Telangana", Capital: "Hyderabad", FormationYear: 2014, OfficialLanguage: "Telugu" },
                {StateName: "Tripura", Capital: "Agartala", FormationYear: 1972, OfficialLanguage: "English" },
                {StateName: "Uttar Pradesh	", Capital: "Lucknow", FormationYear: 1950, OfficialLanguage: "Hindi" },
                {StateName: "Uttarakhand", Capital: "Dehradun", FormationYear: 2000, OfficialLanguage: "Hindi" },
                {StateName: "West Bengal", Capital: "Bengali", FormationYear: 1950, OfficialLanguage: "Bengali" },
                {StateName: "Chandigarh", Capital: "Chandigarh", FormationYear: 1966, OfficialLanguage: "English" },
                {StateName: "Dadra and Nagar Haveli", Capital: "Silvassa", FormationYear: 1961, OfficialLanguage: "Gujarati" },
                {StateName: "Daman and Diu", Capital: "Daman", FormationYear: 1987, OfficialLanguage: "English" },
                {StateName: "Delhi", Capital: "New Delhi", FormationYear: 1956, OfficialLanguage: "Hindi" },
                {StateName: "Lakshadweep", Capital: "Kavaratti", FormationYear: 1956, OfficialLanguage: "English" },
                {StateName: "Puducherry", Capital: "pondicherry", FormationYear: 1962, OfficialLanguage: "English" }
            ];
